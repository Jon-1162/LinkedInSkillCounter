...
df = pd.read_csv('../Data/ScrapedData/linkedinjobs.csv')
...
def getSkillCounts():
    ...
    returnDF.to_csv('../Data/OutputData/skillSetOccurrence.csv', index=True)
    return returnDF
...
def getSkillAllInstancesSumCount():
    ...
    returnDF.to_csv("../Data/OutputData/allSkillInstancesCount.csv", index=True)
    return returnDF
...
def coOccurrence():
    ...
    coOccurrenceDf.to_csv('../Data/OutputData/coOccurrenceDf.csv', index=True)
